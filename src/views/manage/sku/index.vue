<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="skuList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="商品类型" align="center" prop="skuClassName">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="success" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['manage:sku:edit']">修改</el-button>
          <el-button link type="danger" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['manage:sku:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="skuRef" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="商品价格" prop="price">
          <el-input-number v-model="form.price" placeholder="请输入" :min="1" :max="9999" precision="2" :step="0.5" />
          &nbsp;&nbsp;<span>元</span>
        </el-form-item>
...
import {listAllSkuClassBy} from "@/api/manage/skuClass";
...
function handleBeforeUpload(file) {
  ...
  if (props.fileType.length) {
    ...
    isExcel = file.type.indexOf("excel") > -1;
  }
  if (!isExcel) {
...
function getSkuClassList(){
  listAllSkuClassBy(null).then(response => {
