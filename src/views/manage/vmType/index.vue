<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="vmTypeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="货道容量" align="center" prop="channelMaxCapacity" />
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          ...
          <el-button link type="danger" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['manage:vmType:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="vmTypeRef" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="货道数" prop="vmRow">
          <el-input-number v-model="form.vmRow" :min="1" :max="10" placeholder="请输入货道行" />&nbsp;&nbsp;
          <el-input-number v-model="form.vmCol" :min="1" :max="10" placeholder="请输入货道列" />
        </el-form-item>
